...
import com.zyou.ops.util.utils.ToDoubleUtils;
...
/**
 * @BelongsProject: excelDemo
 * @BelongsPackage: com.yhr.excel
 * @Author: yang
 * @CreateTime: 2019-04-02 11:17
 * @Description: Poi 生成高版本xlsx文件
 */

/**
 * 按省每日打卡数据模板
 */
public class ProvinceExportExcel {

   public static void export(String provinceName, List<Map> resultMap, ServletOutputStream out,String format) throws Exception{


       //标题
       String[] title = {"序号", "幼儿园", "班级名称", "出勤人数", "总次数", "饮水", "饮水(次/人)", "饮食", "饮食(次/人)", "睡眠", "睡眠(次/人)",
               "大便", "大便(次/人)", "小便", "小便(次/人)", "洗手", "洗手(次/人)", "离园", "离园(次/人)", "入园心情"};
       ...
       for (int i = 0; i < size; i++) {
               ...
               if (resultMap.get(i).get("happy") != null) {
                   cell2.setCellValue(resultMap.get(i).get("happy").toString());
               } else {
                   cell2.setCellValue("");
               }
               cell2.setCellStyle(titleStyle3);
